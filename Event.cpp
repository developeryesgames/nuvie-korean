...
*/
    ...
    case 216:scroll->display_string(clock->get_time_string());
      scroll->display_string("\n");
      scroll->display_prompt();
      active_alt_code = 0;
      break;
...
void Event::alt_code_teleport_menu(uint32 selection) {
  ...
  } else if (alt_code_input_num == 1) // selected category, select location
  {
    ...
    if (game->get_game_type() == NUVIE_GAME_U6) {
      switch (selection) {
        case 1:scroll->display_string("Cities\n");
          ...
          break;
        case 2:scroll->display_string("Major Areas\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 3:scroll->display_string("Shrines\n");
          ...
          break;
        case 4:scroll->display_string("Gargoyles\n");
          if (!game->is_new_style())
          ...
          get_scroll_input("012345678");
          break;
        case 5:scroll->display_string("Dungeons\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 6:scroll->display_string("More Dungeons\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 7:scroll->display_string("Other\n");
      ...
      switch (selection) {
        case 1:scroll->display_string("Villages\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 2:scroll->display_string("More Villages\n");
          ...
          break;
        case 3:scroll->display_string("Special Places\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 4:scroll->display_string("Resources\n");
          ...
          get_scroll_input("012345678");
          break;
        case 5:scroll->display_string("Teleport Pads\n");
          scroll->display_string(" 1) Barako\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 6:scroll->display_string("Caves\n");
          ...
          get_scroll_input("0123456789");
          break;
        case 7:scroll->display_string("Myrmidex Holes\n");
          if (!game->is_new_style())
      ...
      if (usecode_script != NULL) {
        ...
        switch (script_state) {
          case NUVIE_SCRIPT_GET_DIRECTION :
            ...
            break;
          case NUVIE_SCRIPT_GET_OBJ :usecode_script->resume_with_obj(input.obj);
            if (!game->is_new_style()) {
...
//            view_manager->close_all_gumps();
      ...
      if (usecode_script != NULL) {
        uint8 script_state = usecode_script->get_state();
        switch (script_state) {
          case NUVIE_SCRIPT_GET_DIRECTION : get_direction("");
            break;
          case NUVIE_SCRIPT_GET_OBJ : get_target("");
            break;
        }
      }
...
// FIXME: make ATTACK_MODE use INPUT_MODE
  ...
  switch (new_mode) {
    ...
    case LOOK_MODE: look_start();
      break;
    case TALK_MODE: talk_start();
      break;
    case USE_MODE: use_start();
      break;
    case GET_MODE: get_start();
      break;
    case MULTIUSE_MODE: get_target("");
      if (game->get_party()->is_in_combat_mode())
        player->attack_select_init(false);
      break;
    case ATTACK_MODE: close_gumps();
      if (game->get_game_type() == NUVIE_GAME_U6
      ...
      if (game->get_game_type() != NUVIE_GAME_U6) {
        ...
        switch (scriptThread->get_state()) {
          case NUVIE_SCRIPT_GET_TARGET: get_target(""); break;
        }
        break;
      }
...
//			get_scroll_input(); /* "How many?" */
//			break;
    case REST_MODE:rest_time = rest_guard = 0;
      rest();
      break;
    case COMBAT_MODE: toggle_combat();
      mode = MOVE_MODE;
      break;
    default: cancelAction(); // "what?"
      return (false);
  }
